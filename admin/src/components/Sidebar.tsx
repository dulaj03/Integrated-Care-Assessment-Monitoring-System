...
export const Sidebar = ({ activeTab, onTabChange, onLogout, isOpen, onClose }: SidebarProps) => {
  return (
    <>
      ...
      <aside className={`w-64 h-screen fixed left-0 top-0 bg-slate-900 border-r border-white/5 flex flex-col p-6 z-50 transition-transform duration-300 md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
